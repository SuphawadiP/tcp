...
//         esp_mqtt_client_subscribe(client, "KMITL/SIET/65030269/LED", 1); // Subscribe to the LED control topic
//         break;
...
//         if (strncmp(event->topic, "KMITL/SIET/65030269/LED", event->topic_len) == 0) {
...
//     int msg_id = esp_mqtt_client_publish(client, "KMITL/SIET/65030269/Button", message, 0, 1, 0);
